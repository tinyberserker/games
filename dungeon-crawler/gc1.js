...
const LANG = {
  pl: {
    ...
    world1_complete_sub:'Mroczny Bóg pokonany!',
    world2_ask:'Przejść do Świata II?',
    world2_yes:'[ T ]  TAK — wejdź do Świata II',
    world2_no:'[ N ]  NIE — wróć do początku',
  ...
  en: {
    ...
    world1_complete_sub:'Dark God defeated!',
    world2_ask:'Proceed to World II?',
    world2_yes:'[ Y ]  YES — enter World II',
    world2_no:'[ N ]  NO — return to start',
